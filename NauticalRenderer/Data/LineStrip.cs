...
namespace NauticalRenderer.Data
{
    struct LineStrip
    {
        ...
        public LineStrip(Vector2[] vertices, Color color) : this(vertices.Select(x => new VertexPositionColor(new Vector3(x, 0), color)).ToArray()) { }

        public LineStrip(VertexPositionColor[] vertices)
        {
        ...
        public void Draw(SpriteBatch sb, Matrix viewMatrix)
        {
            ...
            sb.GraphicsDevice.DrawPrimitives(PrimitiveType.LineStrip, 0, vbf.VertexCount - 1);
        }
    }
}
